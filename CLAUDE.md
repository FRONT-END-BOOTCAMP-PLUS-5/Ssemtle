...
- Use the journal tool to capture technical insights, failed approaches, and user preferences
- Search the journal before starting complex tasks for relevant past experiences
- Document architectural decisions and their outcomes
- Track patterns in user feedback to improve collaboration
- Document unrelated issues in journal rather than fixing immediately


# Technical knowledge
- @agent-context/node.md
