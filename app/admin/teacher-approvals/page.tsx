    ...
    <div className="min-h-[932px] w-full bg-[#F8F5FF] md:min-h-[1180px] lg:min-h-[1024px]">
      <div className="mx-auto w-full max-w-[430px] md:max-w-[820px] lg:max-w-[1440px]">
        <div className="flex flex-col items-center">
          <div className="mt-12 mb-4 w-full md:mt-16">
            <div className="mb-8 text-center text-[32px] tracking-tight text-neutral-500 md:text-[36px] lg:ml-8 lg:text-left lg:text-[32px]">
              선생님 승인
            </div>
          </div>

          <div className="grid w-full grid-cols-1 place-items-center gap-6 px-4 md:grid-cols-2 md:gap-8 md:px-6 lg:grid-cols-3 lg:place-items-start lg:content-start lg:justify-start lg:gap-10 lg:px-8">
