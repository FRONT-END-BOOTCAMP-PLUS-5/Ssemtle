      ...
      <div className="w-full px-4 py-8 sm:px-6 lg:mx-auto lg:max-w-[970px] lg:px-8 lg:py-16">
        <div className="mb-8 flex flex-col items-center sm:flex-row sm:justify-between">
          ...
          <button
            ...
            className="h-10 w-40 cursor-pointer rounded bg-indigo-400 text-xs font-semibold tracking-tight text-white shadow-[0px_4px_10px_0px_rgba(16,156,241,0.24)] transition-all hover:bg-indigo-500 lg:h-[42px] lg:w-[160px] lg:bg-[#8979FF] lg:text-[13px] lg:tracking-[0.13px] lg:hover:bg-[#7A6AFF]"
          >
            과목등록
          </button>
        </div>
